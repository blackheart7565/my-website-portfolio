...
const AboutMe = () => {
	return (
		<div>
			...
			<div>English</div>
			<p>
				My name is <span>Vitaliy</span>, and I am a junior developer with a profound interest in creating innovative software solutions. I have a stable foundation in programming languages such as JavaScript, TypeScript, and experience working with technologies like <span>HTML, CSS, React, MongoDB, PostgreSQL, Tailwind, Express, NodeJS, ReduxJS, Git</span>.
